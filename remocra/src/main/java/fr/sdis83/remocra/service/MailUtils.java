...
public class MailUtils {
    ...
    // Via utilisateur
    public void envoiEmailWithModele(EmailModele modele, Utilisateur expediteur, Utilisateur destinataire, EmailModeleKeyMap args) {
        envoiEmail(expediteur, destinataire, modele.getObjetReplaced(args), modele.getCorpsReplaced(args));
    }

    public void envoiEmail(Utilisateur expediteur, Utilisateur destinataire, String objet, String corps) {
    ...
    public void envoiEmailWithModele(EmailModele modele, Utilisateur expediteur, String destinataire, EmailModeleKeyMap args) {
        envoiEmail(expediteur, destinataire, modele.getObjetReplaced(args), modele.getCorpsReplaced(args));
    }
    ...
    protected static String getPrettyDblString(String st1, String st2) {
        return (st1 == null ? "" : st1) + (st1 != null && st2 != null ? " " : "") + (st2 == null ? "" : st2);
    }
}

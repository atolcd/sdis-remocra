...
public abstract class AbstractService<T> {
    ...
    protected boolean processItemSortings(ArrayList<Order> orders, ItemSorting itemSorting, CriteriaBuilder cBuilder, Root<T> from) {
        return false;
    }
     ...
     * @return
     */
    public List<T> find(Integer firstResult, Integer maxResults, List<ItemSorting> itemSortings, List<ItemFilter> itemFilters) {
    ...
    protected void manageParameters(Query itemTypedQuery, Map<String, Object> parameters, List<ItemFilter> itemFilters) {
    ...
    @Transactional
    public T update(Long id, String json, Map<String, MultipartFile> files, Object... params) throws Exception {
        if (id == null) {
            return null;
        }

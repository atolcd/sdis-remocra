...
public class ParamConfService {
  ...
  public String getDossierCourriersExternes() {
    return (String) this.getValue(ParamConfParam.DOSSIER_COURRIER);
  }
  ...
  public String getHydrantLongueIndisponibiliteTypeOrganisme() {
    return (String)
        this.getValue(
            ParamConfParam.HYDRANT_LONGUE_INDISPONIBILITE_TYPEORGANISME, "^(COMMUNE|EPCI)$");
  }
  ...
  public static String HYDRANT_COLONNES_DEFAULT[] = {
    "numero", "nomTournee", "natureNom", "dateReco", "dateContr", "dispoTerrestre", "dispoHbe"
  };
  ...
  public Object getHydrantCfg() {
    ...
    data.put(
        "delai_rnvl_reco_prive", this.getValue(ParamConfParam.HYDRANT_RENOUVELLEMENT_RECO_PRIVE));
    data.put(
        "delai_rnvl_reco_public", this.getValue(ParamConfParam.HYDRANT_RENOUVELLEMENT_RECO_PUBLIC));
    ...
    data.put(
        "delai_rnvl_ctrl_prive", this.getValue(ParamConfParam.HYDRANT_RENOUVELLEMENT_CTRL_PRIVE));
    data.put(
        "delai_rnvl_ctrl_public", this.getValue(ParamConfParam.HYDRANT_RENOUVELLEMENT_CTRL_PUBLIC));
  ...
  public String getLdapUserFilter() {
    return (String)
        this.getValue(
            ParamConfParam.PDI_LDAP_USER_FILTER,

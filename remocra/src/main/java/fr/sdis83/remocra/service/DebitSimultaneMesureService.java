...
@Configuration
public class DebitSimultaneMesureService<T extends DebitSimultaneMesure>
    extends AbstractService<DebitSimultaneMesure> {
  ...
  protected Predicate processFilterItem(
      ...
      Root<DebitSimultaneMesure> from,
  ...
  public void updateMany(String json, Map<String, MultipartFile> files) throws Exception {
    ...
    for (HashMap<String, Object> obj : liste) {
      ...
      if (obj.get("id") != null) {
        DebitSimultaneMesure mesure =
            this.entityManager.find(this.cls, Long.valueOf(obj.get("id").toString()));

        mesure.setDateMesure(
            new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
                .parse(String.valueOf(obj.get("dateMesure"))));
        obj.remove("dateMesure");

        JSONDeserializer<DebitSimultaneMesure> deserializer =
            new JSONDeserializer<DebitSimultaneMesure>();
        deserializer
            .use(null, this.cls)
  ...
  @Transactional
  public DebitSimultaneMesure create(HashMap<String, Object> obj, Map<String, MultipartFile> files)
      throws Exception {
    JSONDeserializer<DebitSimultaneMesure> deserializer =
        new JSONDeserializer<DebitSimultaneMesure>();
    deserializer
    ...
    Date date =
        new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(String.valueOf(obj.get("dateMesure")));
    obj.remove("dateMesure");
  ...
  @Transactional
  public DebitSimultaneMesure setUpInformation(
      DebitSimultaneMesure attached, Map<String, MultipartFile> files, HashMap<String, Object> obj)
      throws Exception {

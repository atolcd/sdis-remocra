...
public class ProfilUtilisateurService extends AbstractService<ProfilUtilisateur> {
    ...
    @Override
    protected boolean processItemSortings(ArrayList<Order> orders, ItemSorting itemSorting, CriteriaBuilder cBuilder, Root<ProfilUtilisateur> from) {
    ...
    @Override
    protected Predicate processFilterItem(CriteriaQuery<?> itemQuery, Map<String, Object> parameters, Root<ProfilUtilisateur> from, ItemFilter itemFilter) {

...
@Configuration
public class ProfilOrganismeUtilisateurDroitService extends AbstractService<ProfilOrganismeUtilisateurDroit> {
    ...
    @Override
    protected boolean processItemSortings(ArrayList<Order> orders, ItemSorting itemSorting, CriteriaBuilder cBuilder, Root<ProfilOrganismeUtilisateurDroit> from) {

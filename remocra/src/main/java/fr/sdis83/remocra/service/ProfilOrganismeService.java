...
public class ProfilOrganismeService extends AbstractService<ProfilOrganisme> {
    ...
    @Override
    protected boolean processItemSortings(ArrayList<Order> orders, ItemSorting itemSorting, CriteriaBuilder cBuilder, Root<ProfilOrganisme> from) {
    ...
    @Override
    protected Predicate processFilterItem(CriteriaQuery<?> itemQuery, Map<String, Object> parameters, Root<ProfilOrganisme> from, ItemFilter itemFilter) {

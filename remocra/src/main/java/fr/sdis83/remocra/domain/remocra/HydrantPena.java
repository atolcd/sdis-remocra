...
public class HydrantPena extends Hydrant {
  ...
  @Column private String coordDFCI;

  @Column private String capacite;

  @Column private Double qAppoint;

  @ManyToOne private TypeHydrantVolConstate volConstate;

  @ManyToOne private TypeHydrantPositionnement positionnement;

  @ManyToOne private TypeHydrantMateriau materiau;
  ...
  @Column private Boolean illimitee;

  @Column private Boolean incertaine;

  public Feature toFeature() {
    Feature feature = super.toFeature();
    if (this.hbe != null
        && this.hbe.booleanValue()
        && this.getDispoHbe() != Disponibilite.INDISPO) {

...
privileged aspect HydrantPibi_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> HydrantPibi.fieldNames4OrderClauseFilter = java.util.Arrays.asList("diametre", "debit", "debitMax", "pression", "pressionDyn", "pressionDynDeb", "gestReseau", "numeroSCP", "choc", "marque", "modele", "pena");

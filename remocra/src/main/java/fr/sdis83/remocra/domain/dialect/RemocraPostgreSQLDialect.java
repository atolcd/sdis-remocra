...
public class RemocraPostgreSQLDialect extends PostgisDialect {
  ...
  public RemocraPostgreSQLDialect() {
    ...
    registerFunction(
        "soundexfr", new StandardSQLFunction("remocra.soundex_fr", StandardBasicTypes.STRING));
    registerFunction(
        "jarowinkler", new StandardSQLFunction("remocra.jaro_winkler", StandardBasicTypes.DOUBLE));
  }
}

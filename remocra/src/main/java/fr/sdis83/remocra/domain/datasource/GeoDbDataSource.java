...
public class GeoDbDataSource extends SimpleDriverDataSource {
    ...
    /**
     * Ajoute les fonctions nécessaires au bon fonctionnement de l'application
     * avec GeoDB
     * 
     * @param cx
     * @throws SQLException
    ...
    void addMissingFunctions(Connection cx) throws SQLException {
        try {
            ...
            try {
                try {
                    st.execute("CREATE ALIAS ST_Distance_Sphere FOR \"fr.sdis83.remocra.domain.datasource.GeoDbDataSource.ST_Distance_Sphere\"");
                } catch (SQLException e) {
                    // tant pis !
                }
            } finally {
            ...
            throw (SQLException) new SQLException("Pb GeoDB : ajout des fonctions manquantes").initCause(e);
        }
    }
    ...
    public static double ST_Distance_SphereInternal(double lon1, double lat1, double lon2, double lat2) {
    ...
    public static double ST_Distance_SphereInternal(double lon1, double lat1, double lon2, double lat2, double earthRadius,

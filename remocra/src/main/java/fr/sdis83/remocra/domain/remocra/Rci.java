...
public class Rci implements Featurable {
  ...
  @NotNull @ManyToOne TypeRciOrigineAlerte origineAlerte;
  ...
  @ManyToOne private Utilisateur arriveeDdtmOnf;

  @ManyToOne private Utilisateur arriveeSdis;

  @ManyToOne private Utilisateur arriveeGendarmerie;

  @ManyToOne private Utilisateur arriveePolice;

  @NotNull private String pointEclosion;
  ...
  @ManyToOne private TypeRciPromCategorie categoriePromethee;

  @ManyToOne private TypeRciPromPartition partitionPromethee;

  @ManyToOne private TypeRciPromFamille famillePromethee;

  @ManyToOne private TypeRciRisqueMeteo risqueMeteo;

  @ManyToOne private TypeRciDegreCertitude degreCertitude;
  ...
  public static Rci fromJsonToRci(String json) {
    return new JSONDeserializer<Rci>()
        .use(null, Rci.class)

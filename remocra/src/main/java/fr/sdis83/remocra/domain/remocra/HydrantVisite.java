...
public class HydrantVisite {
  ...
  @ManyToOne @NotNull private Hydrant hydrant;
  ...
  @ManyToOne private TypeHydrantSaisie type;

  @Column private Boolean ctrl_debit_pression;
  ...
  @Column private String anomalies;
  ...
  @Column private Integer debitAutre;

  @Column private Double pressionDynAutre;
}

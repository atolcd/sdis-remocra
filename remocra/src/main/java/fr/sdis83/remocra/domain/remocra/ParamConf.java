...
@RooJpaActiveRecord(
    versionField = "",
    finders = {"findParamConfsByCleEquals"})
...
public class ParamConf {
  ...
  public static enum ParamConfParam {
    ...
    CITERNE_TOLERANCE_ASSOCIATION_PI_METRES(
        "CITERNE_TOLERANCE_ASSOCIATION_PI_METRES", Integer.class),
    ...
    ID_TRAITEMENT_NB_ALERTES_PAR_UTILISATEUR(
        "ID_TRAITEMENT_NB_ALERTES_PAR_UTILISATEUR", Integer.class),
    ...
    HYDRANT_LONGUE_INDISPONIBILITE_TYPEORGANISME(
        "HYDRANT_LONGUE_INDISPONIBILITE_TYPEORGANISME", String.class),
    ...
    public static Class getClassFromCle(String cle) {
      ...
      for (ParamConfParam o : ParamConfParam.values()) {
        if (o.getCle().toLowerCase().equals(cle.toLowerCase())) return o.getCl();
      }
      return String.class;
    }
  }

  @Id private String cle;

  @NotNull private String valeur;

  private String description;

  @NotNull private String nomgroupe;

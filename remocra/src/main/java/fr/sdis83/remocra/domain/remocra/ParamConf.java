...
public class ParamConf {
    ...
    public static enum ParamConfParam {
        ...
        CRISE_NOUVEL_EVT_DELAI_MINUTES("CRISE_NOUVEL_EVT_DELAI_MINUTES", Integer.class),
        ...
        HYDRANT_RENOUVELLEMENT_RECO_PRIVE("HYDRANT_RENOUVELLEMENT_RECO_PRIVE", Integer.class),
        HYDRANT_RENOUVELLEMENT_RECO_PUBLIC("HYDRANT_RENOUVELLEMENT_RECO_PUBLIC", Integer.class),
        HYDRANT_RENOUVELLEMENT_CTRL_PRIVE("HYDRANT_RENOUVELLEMENT_CTRL_PRIVE", Integer.class),
        HYDRANT_RENOUVELLEMENT_CTRL_PUBLIC("HYDRANT_RENOUVELLEMENT_CTRL_PUBLIC", Integer.class),
        ...
        HYDRANT_LONGUE_INDISPONIBILITE_JOURS("HYDRANT_LONGUE_INDISPONIBILITE_JOURS", Integer.class),
        HYDRANT_LONGUE_INDISPONIBILITE_MESSAGE("HYDRANT_LONGUE_INDISPONIBILITE_MESSAGE", String.class),
        HYDRANT_LONGUE_INDISPONIBILITE_TYPEORGANISME("HYDRANT_LONGUE_INDISPONIBILITE_TYPEORGANISME", String.class),
        HYDRANT_COLONNES("HYDRANT_COLONNES", String.class),
        HYDRANT_ZOOM_NUMERO("HYDRANT_ZOOM_NUMERO", Boolean.class),
        HYDRANT_DEPLACEMENT_DIST_WARN("HYDRANT_DEPLACEMENT_DIST_WARN", Integer.class),
        HYDRANT_GENERATION_CARTE_TOURNEE("HYDRANT_GENERATION_CARTE_TOURNEE", Boolean.class),
        HYDRANT_METHODE_TRI_ALPHANUMERIQUE("HYDRANT_METHODE_TRI_ALPHANUMERIQUE", Boolean.class),
        HYDRANT_TOLERANCE_COMMUNE_METRES("HYDRANT_TOLERANCE_COMMUNE_METRES", Long.class),
        ...
        VITESSE_EAU("VITESSE_EAU", Integer.class),
        // JWT

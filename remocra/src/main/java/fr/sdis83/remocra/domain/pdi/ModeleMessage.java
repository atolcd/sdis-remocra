...
public class ModeleMessage {
    ...
    @OneToMany(mappedBy = "messageSucces", cascade = { javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.MERGE })
    private Set<ModeleTraitement> modeleTraitements;

    @OneToMany(mappedBy = "messageEchec", cascade = { javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.MERGE })

...
public class JSONMap<K, V> extends HashMap<K, V> {
  ...
  /**
   * Transforme un objet HashMap (crée depuis une chaîne de caractère transmise au serveur) en objet
   * JSONMap Contrairement à ces HashMap, les JSONMap peuvent supporter les caractères spéciaux en
   * étant compatible avec le deserializer de FlexJSON
   */

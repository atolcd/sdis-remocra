...
public class Permis {
  ...
  @NotNull private String voie;

  @NotNull private String complement;

  @NotNull private String numero;

  @NotNull @ManyToOne private TypePermisAvis avis;

  @NotNull @ManyToOne private TypePermisInterservice interservice;

  @NotNull private String sectionCadastrale;

  @NotNull private String parcelleCadastrale;

  @NotNull private String observations;

  @NotNull @ManyToOne private TypeOrganisme serviceInstructeur;

  @NotNull private Integer annee;

  @NotNull @ManyToOne private Utilisateur instructeur;
  ...
  public static Permis fromJsonToPermis(String json) {
    return new JSONDeserializer<Permis>()
        .use(null, Permis.class)

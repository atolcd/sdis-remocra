...
@RooJavaBean
@RooJpaActiveRecord(versionField = "", table = "modele_traitement", schema = "pdi", finders = { "findModeleTraitementsByCode" })
@RooDbManaged(automaticallyDelete = true)
@RooToString(excludeFields = { "modeleTraitementParametres", "traitements", "messageSucces", "messageEchec" })

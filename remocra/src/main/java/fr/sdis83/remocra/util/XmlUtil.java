...
public class XmlUtil {
    ...
    private final static Logger logger = Logger.getLogger(XmlUtil.class.getClass());

    public static <T> void serializeXml(Class<?> classe, Object lst, String referentiel, OutputStream out) throws BusinessException {
        try {
            ...
            throw new BusinessException("Problème avec la sérialisation des " + referentiel + " : " + e.getMessage());
        }
    }

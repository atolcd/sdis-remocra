...
/**
 * Gère les exceptions lors de l'authentification 401 si en AJAX ou redirect si HTML
 *
 * @author cva
 */
public class CustomAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {
  ...
  /**
   * Permet de prendre en compte les 401/AuthenticationException pour la requete AJAX
   * d'Authentification
   */
  @Override
  public void commence(
    ...
    if (isAjax && authException != null) {
      ...
      logger.debug(
          "Intercepting Authentication Exception to prevent redirect to Login : ", authException);

      // Requête Ajax => Gestion par statuts HTTP 401
      AuthenticationException e =
          ExceptionUtils.getNestedExceptionWithClass(authException, AuthenticationException.class);
      if (e != null) {

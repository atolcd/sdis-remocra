...
/**
 * Recupère le profile et les droits d'accès d'un utilisateur en fonction de son profil et de son
 * organisme.
 */
@Configuration
public class ProfileProvider {
   ...
   *
   * <p>La lecture des droits se fait dans le fichier (en minuscules) dans le dossier ressource :
   * security/profiles/[TypeOrganisme]_[Profil].properties
   *
   * @param profil
   * @param organisme
   * @return
   ...
   */
  @Transactional
  public Collection<AccessRight> getProfileAccessRights(
      ProfilUtilisateur profilUtilisateur, ProfilOrganisme profilOrganisme)
      throws BusinessException {
    ...
    if (profil == null) {
      ...
      String message =
          "ProfileProvider : le profil de droit n'est pas renseigné pour le profil organisme "

...
/**
 * Surcharge ou rajoute de nouvelle methodes pouvant être utilisée dans les annotations de sécurité
 * Pre et Post.
 *
 * @author bpa
 */
public class CustomSecurityExpressionRoot extends SecurityExpressionRoot {
  ...
  public CustomSecurityExpressionRoot(
      Authentication a, AuthoritiesUtil authUtils, CustomPermissionEvaluator permEval) {
    super(a);

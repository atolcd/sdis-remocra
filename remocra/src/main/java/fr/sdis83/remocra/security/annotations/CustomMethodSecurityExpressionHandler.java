...
public class CustomMethodSecurityExpressionHandler extends DefaultMethodSecurityExpressionHandler implements
     ...
     */
    @Override
    public SecurityExpressionRoot createSecurityExpressionRoot(Authentication auth, MethodInvocation mi) {
        CustomSecurityExpressionRoot customSecurityExpressionRoot = (CustomSecurityExpressionRoot) new CustomSecurityExpressionRoot(
                auth, authUtils, customPermissionEvaluator);

...
@RequestMapping("/typehydrantniveau")
@Controller
public class TypeHydrantNiveauController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeHydrantNiveauController() {
        super(TypeHydrantNiveau.class);
    }

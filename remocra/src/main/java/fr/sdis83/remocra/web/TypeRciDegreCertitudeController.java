...
@RequestMapping("/typercidegrecertitude")
@Controller
public class TypeRciDegreCertitudeController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeRciDegreCertitudeController() {
        super(TypeRciDegreCertitude.class);
    }

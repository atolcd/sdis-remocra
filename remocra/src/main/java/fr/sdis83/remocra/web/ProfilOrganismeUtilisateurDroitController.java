...
@Controller
public class ProfilOrganismeUtilisateurDroitController
    extends AbstractServiceableController<
        ProfilOrganismeUtilisateurDroitService, ProfilOrganismeUtilisateurDroit> {

  @Autowired private ProfilOrganismeUtilisateurDroitService service;

...
@Controller
public class OldebVisiteController
    extends AbstractServiceableController<OldebVisiteService, OldebVisite> {

  @Autowired private OldebVisiteService service;
  ...
  public ResponseEntity<java.lang.String> listJson(
    ...
    return new AbstractExtListSerializer<OldebVisite>("OldebVisite retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        serializer
            .include("data.nomAvis")
            .include("data.totalAnomalies")
            .include("data.oldebVisiteSuites")
            .include("data.oldebVisiteDocuments")
            .include("data.typeOldebAnomalies")
            .include("data.nomAction")
            .include("data.nomDebAcces")
            .include("data.nomDebParcelle");

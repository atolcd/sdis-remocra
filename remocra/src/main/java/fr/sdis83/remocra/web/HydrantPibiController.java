...
public class HydrantPibiController {
  ...
  @Autowired private HydrantPibiRepository hydrantPibiRepository;
  ...
  protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
    return serializer
        ...
        // tournees
        .include("data.tournees.id")
        .include("data.tournees.nom")
        .include("data.utilisateurModification.id")
        .include("data.utilisateurModification.nom")
        ...
        .include("data.photo")
        // Documents
        .include("data.hydrantDocuments.id")
        .include("data.hydrantDocuments.titre")
        .include("data.hydrantDocuments.code")
  ...
  public ResponseEntity<java.lang.String> listJson(
    ...
    return new AbstractExtListSerializer<HydrantPibi>(
        "fr.sdis83.remocra.domain.remocra.HydrantPibi retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return new JSONSerializer()
            .include(
                ...
                "data.jumele.id")
            .exclude("data.commune.geometrie", "data.pena.*", "data.jumele.*", "*.class")
  ...
  public ResponseEntity<java.lang.String> getHydrant(final @PathVariable("id") Long id) {
    ...
    return new AbstractExtObjectSerializer<HydrantPibi>(
        "fr.sdis83.remocra.domain.remocra.Hydrant-Pibi retrieved.") {
  ...
  public ResponseEntity<java.lang.String> createHydrant(MultipartHttpServletRequest request) {
    ...
    try {
      ...
      if (attached != null) {
        return new AbstractExtObjectSerializer<HydrantPibi>(
            "Hydrant Pibi created.", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
          @Override
          protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
            return HydrantPibiController.this.additionnalIncludeExclude(serializer);
          }
      ...
      ConstraintViolationException dke =
  ...
  public ResponseEntity<java.lang.String> createHydrantFiche(MultipartHttpServletRequest request) {
    ...
    try {
      ...
      return new SuccessErrorExtSerializer(false, e.getMessage(), HttpStatus.BAD_REQUEST)
          .serialize();
    }
  }

  @RequestMapping(
      value = "/updateHydrant/{id}",
      method = RequestMethod.POST,
      headers = "Content-Type=multipart/form-data")
  @PreAuthorize(
      "hasRight('HYDRANTS_C') or hasRight('HYDRANTS_RECONNAISSANCE_C') or hasRight('HYDRANTS_CONTROLE_C')")
  public ResponseEntity<java.lang.String> updateHydrantFiche(
  ...
  @PreAuthorize(
      "hasRight('HYDRANTS_C') or hasRight('HYDRANTS_RECONNAISSANCE_C') or hasRight('HYDRANTS_CONTROLE_C')")
  public ResponseEntity<java.lang.String> updateHydrant(
      final @PathVariable Long id, MultipartHttpServletRequest request) {
    String json = request.getParameter("hydrant");
    Map<String, MultipartFile> files = request.getFileMap();
    try {
      ...
      if (attached != null) {
        ...
        return new AbstractExtObjectSerializer<HydrantPibi>(
            "Hydrant Pibi updated.", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
          @Override
          protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
            return HydrantPibiController.this.additionnalIncludeExclude(serializer);
          }
  ...
  @RequestMapping(
      value = "/histoverifhydrau/{id}",
      method = RequestMethod.GET,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('HYDRANTS_R')")
  public ResponseEntity<java.lang.String> getHistoVerifHydrau(final @PathVariable Long id) {

    return new AbstractExtObjectSerializer<HistoVerificationHydraulique>(
        "Hydrant Pibi historique vérification hydraulique retrieved.") {
      @Override
  ...
  @RequestMapping(
      value = "/histoverifhydrauforchart/{id}",
      method = RequestMethod.GET,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('HYDRANTS_R')")
  public ResponseEntity<java.lang.String> getHistoVerifHydrauForChart(final @PathVariable Long id) {

    return new AbstractExtObjectSerializer<HistoriqueModel>(
        "Hydrant Pibi historique vérification hydraulique retrieved.") {
      @Override
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return serializer.exclude("*.class").include("data.*").include("total").include("message");
      }
  ...
  @RequestMapping(
      ...
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('HYDRANTS_R')")
  public ResponseEntity<java.lang.String> findjumelage(
      final @RequestParam(value = "geometrie") String geometrie) {
    HttpHeaders responseHeaders = new HttpHeaders();
    responseHeaders.add("Content-Type", "application/json;charset=utf-8");
    return new ResponseEntity<String>(
        hydrantPibiRepository.findJumelage(geometrie).toString(), responseHeaders, HttpStatus.OK);
  }
}

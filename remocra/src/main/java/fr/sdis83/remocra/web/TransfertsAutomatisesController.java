...
public class TransfertsAutomatisesController {
  ...
  @Autowired TransfertsAutomatisesRepository transfertsAutomatisesRepository;

  @RequestMapping(value = "", method = RequestMethod.GET, headers = "Accept=application/json")
  public ResponseEntity<String> getTypesOrganismeAcces() {
    return new AbstractExtObjectSerializer<List<Map<String, Object>>>(
        "fr.sdis83.remocra.domain.remocra.TransfertsAutomatisesController retrieved.") {
  ...
  public ResponseEntity<java.lang.String> updateAdministrer(
    ...
    try {
      ...
      e.printStackTrace();
      return new SuccessErrorExtSerializer(false, "Erreur dans la modification des accès")
          .serialize();
    }
  }
  ...
  @RequestMapping(
      ...
      method = RequestMethod.POST,
      headers = "Accept=application/json")
  public ResponseEntity<java.lang.String> updateTransmettre(
      @PathVariable Long id, @RequestBody String json) {
    try {
      HashMap<String, Object> param =
          new JSONDeserializer<HashMap<String, Object>>().deserialize(json);
  ...
  @RequestMapping(
      ...
      method = RequestMethod.POST,
      headers = "Accept=application/json")
  public ResponseEntity<java.lang.String> updateRecuperer(
      @PathVariable Long id, final @RequestBody String json) {
    try {
      HashMap<String, Object> param =
          new JSONDeserializer<HashMap<String, Object>>().deserialize(json);

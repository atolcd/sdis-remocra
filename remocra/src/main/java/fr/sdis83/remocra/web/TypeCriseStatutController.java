...
@RequestMapping("/typecrisestatut")
@Controller
public class TypeCriseStatutController {
  ...
  public ResponseEntity<String> listJson(
    ...
    return new AbstractExtListSerializer<TypeCriseStatut>("TypeCriseStaut retrieved.") {
      ...
      @Override
      protected List<TypeCriseStatut> getRecords() {
        return typeCriseStatutRepository.getAll(itemFilterList);
      }

      @Override
      protected Long countRecords() {
        return Long.valueOf(typeCriseStatutRepository.count());
      }
    }.serialize();
  }
}

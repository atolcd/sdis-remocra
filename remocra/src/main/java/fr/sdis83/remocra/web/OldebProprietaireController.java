...
@Controller
public class OldebProprietaireController extends AbstractServiceableController<OldebProprietaireService, OldebProprietaire> {

    @Autowired
    private OldebProprietaireService service;

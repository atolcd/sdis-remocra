...
@RequestMapping("/typercipromcategories")
@Controller
public class TypeRciPromCategorieController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeRciPromCategorieController() {
        super(TypeRciPromCategorie.class);
    }

...
public class DebitSimultaneHydrantController {
  ...
  @Autowired private DebitSimultaneHydrantService DebitSimultaneHydrantService;
  ...
  public ResponseEntity<String> listJson(
    ...
    return new AbstractExtListSerializer<DebitSimultaneHydrant>(
        "DebitSimultaneHydrant retrieved.") {
      ...
      protected Long countRecords() {
        return Long.valueOf(DebitSimultaneHydrantService.count(itemFilterList));
      }
    }.serialize();
  }
}

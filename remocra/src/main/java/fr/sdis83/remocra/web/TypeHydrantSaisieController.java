...
@RequestMapping("/typehydrantsaisies")
@Controller
public class TypeHydrantSaisieController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeHydrantSaisieController() {
        super(TypeHydrantSaisie.class);
    }

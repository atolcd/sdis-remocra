...
public class RciController extends AbstractServiceableController<RciService, Rci> {
    ...
    protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return serializer
        // Commune
                .include("data.commune.id").include("data.commune.nom").exclude("data.commune.*")
                // Documents
                .include("data.rciDocuments.id").include("data.rciDocuments.titre").include("data.rciDocuments.code").exclude("data.rciDocuments.*")
                // Global
                .exclude("*.class");
    }
    ...
    public ResponseEntity<java.lang.String> update(final @PathVariable("id") Long id, MultipartHttpServletRequest request, final @RequestParam String jsonRci,
        ...
        try {
            ...
            if (attached != null) {
                ...
                return new AbstractExtObjectSerializer<Rci>("Model updated", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
                    @Override
                    protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
                        return RciController.this.additionnalIncludeExclude(serializer);
                    }
    ...
    public ResponseEntity<java.lang.String> create(MultipartHttpServletRequest request, final @RequestParam String jsonRci, final @RequestParam int fileCounter) {
        ...
        try {
            ...
            return new AbstractExtObjectSerializer<Rci>("Model created", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
                @Override
                protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
                    return RciController.this.additionnalIncludeExclude(serializer);
                }
    ...
    public ResponseEntity<java.lang.String> deplacer(final @PathVariable(value = "id") Long id, final @RequestParam(value = "geometrie") String geometrie,
        ...
        try {
            ...
            return new SuccessErrorExtSerializer(false, "Problème survenu lors du déplacement du départ de feu").serialize();
        }

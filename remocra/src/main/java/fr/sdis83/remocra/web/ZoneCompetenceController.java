...
@Controller
public class ZoneCompetenceController
    extends AbstractServiceableController<ZoneCompetenceService, ZoneCompetence> {

  @Autowired private ZoneCompetenceService service;
  ...
  public ResponseEntity<java.lang.String> checkByXY(
    ...
    try {
      ...
      return new SuccessErrorExtSerializer(
              result, "zonecompetences - check " + (result ? "OK" : "NOK"))
          .serialize();
    } catch (Exception e) {

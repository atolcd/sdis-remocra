...
public class DebitSimultaneMesureController {
  ...
  @Autowired private DebitSimultaneMesureService debitSimultaneMesureService;
    ...
    return new AbstractExtListSerializer<DebitSimultaneMesure>("DebitSimultaneMesure retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return new JSONSerializer()
            .exclude("*.class")
            .exclude("data.hydrants")
            .include("data.*")
            .exclude("*.class")
            .transform(new GeometryTransformer(), Geometry.class);
        // return new JSONSerializer().exclude("*.class").include("data.*").transform(new
        // GeometryTransformer(), Geometry.class);
      ...
      protected Long countRecords() {
        return Long.valueOf(debitSimultaneMesureService.count(itemFilterList));
      }
    }.serialize();
  }

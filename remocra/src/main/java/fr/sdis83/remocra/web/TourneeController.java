...
public class TourneeController {
  ...
  public ResponseEntity<java.lang.String> listJson(
    ...
    return new AbstractExtListSerializer<Tournee>(
        "fr.sdis83.remocra.domain.remocra.Tournee retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return serializer
            ...
            .exclude(
                "data.affectation.organismeParent.profilOrganisme.typeOrganisme.typeOrganismeParent")
            .exclude(
                "data.affectation.organismeParent.typeOrganisme.typeOrganismeParent.typeOrganismeParent")
  ...
  @RequestMapping(
      ...
      headers = {"Accept=application/xml", "Accept=application/xml;charset=utf-8"})
  @PreAuthorize("hasRight('TOURNEE_R')")
  public ResponseEntity<String> getTourneeDisponible(
    ...
    for (Tournee tournee : tournees) {
      stringWriter.append(
          "<tournee nom=\"" + tournee.getNom().toString().replaceAll("\"", "&quot;") + "\">");
  ...
  public ResponseEntity<java.lang.String> resettournee(@PathVariable("id") Long id) {
    try {
      ...
      return new SuccessErrorExtSerializer(
              true, "La tournée " + attached.getNom() + " a été réinitialisée")
          .serialize();
    } catch (Exception e) {
      return new SuccessErrorExtSerializer(false, e.getMessage()).serialize();
    }
  ...
  public ResponseEntity<java.lang.String> finalisetournee(@PathVariable("id") Long id) {
    try {
      ...
      attached.flush();
      return new SuccessErrorExtSerializer(
              true, "La tournée " + attached.getNom() + " a été finalisée")
          .serialize();
    } catch (Exception e) {
      return new SuccessErrorExtSerializer(false, e.getMessage()).serialize();
    }
  ...
  @PreAuthorize("hasRight('TOURNEE_C')")
  public ResponseEntity<java.lang.String> renametournee(
      @PathVariable("id") Long id, final @RequestParam(value = "nom") String nom) {
    try {
      Tournee attached = Tournee.findTournee(id);
      attached.setNom(nom);
      attached.flush();
      return new SuccessErrorExtSerializer(
              true, "La tournée " + attached.getNom() + " a été renommée")
          .serialize();
    } catch (Exception e) {
      if (ExceptionUtils.getNestedExceptionWithClass(e, ConstraintViolationException.class)
          != null) {
        return new SuccessErrorExtSerializer(
                false, "Une tournée avec le nom " + nom + " existe déjà")
            .serialize();
      }
      return new SuccessErrorExtSerializer(false, e.getMessage()).serialize();
    }
  ...
  public ResponseEntity<java.lang.String> getHydrantTournee(@PathVariable("id") Long id) {
    try {
      ...
      for (String numero : listeHydrants) sb.append("<li>").append(numero).append("</li>");

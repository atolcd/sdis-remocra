...
/**
 * Classe de retour d'une parcelle suivant différentes provenances (OLD,
 * CADASTRE..)
 *
 */
...
public class CadastreParcelleController {
    ...
    @Autowired
    private CadastreParcelleService cadastreParcelleService;
    ...
    /**
     * Mise à jour du sérializer s'il y a la géometrie de la parcelle à
     * retourner
     *
     * @param itemFilterList
     * @param serializer
     */
    private void updateSerialiezWithGeometrie(final List<ItemFilter> itemFilterList, JSONSerializer serializer) {

...
public class ProfilDroitController
    extends AbstractServiceableController<ProfilDroitService, ProfilDroit> {

  private final Logger logger = Logger.getLogger(getClass());

  @Autowired private ProfilDroitService service;
  ...
  @RequestMapping(
      value = "/{to}/droits/copyfrom/{from}",
      method = RequestMethod.PUT,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('REFERENTIELS_C')")
  public ResponseEntity<java.lang.String> copydroits(
      final @PathVariable Long from, final @PathVariable Long to) {
    try {

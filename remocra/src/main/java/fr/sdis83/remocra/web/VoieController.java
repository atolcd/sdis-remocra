...
public class VoieController {
  ...
  @Autowired private VoieService voieService;

  @RequestMapping(value = "/mc", headers = "Accept=application/json")
  public ResponseEntity<java.lang.String> listMotClassantOrNomJson(
    ...
    return new AbstractExtListSerializer<Voie>("Voies retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return serializer
            .include("data.id")
            .include("data.nom")
            .include("data.motClassant")
            .include("data.source")
            .include(withgeom ? "data.geometrie" : "")
            .include(withgeom ? "data.commune.id" : "")
            .include(withgeom ? "data.commune.code" : "")
            .include(withgeom ? "data.commune.insee" : "")

...
public class RedashController {
  ...
  public void api(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      String redashUrl =
          "http://localhost:5000" + request.getContextPath() + request.getServletPath();
      ...
      UriComponents c =
          b.queryParam("p_utilisateur", u.getId())
      ...
      if (srcResponse.getEntity() != null) {
        try (InputStream is = srcResponse.getEntity().getContent();

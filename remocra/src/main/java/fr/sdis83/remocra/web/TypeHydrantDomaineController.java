...
@RequestMapping("/typehydrantdomaines")
@Controller
public class TypeHydrantDomaineController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeHydrantDomaineController() {
        super(TypeHydrantDomaine.class);
    }

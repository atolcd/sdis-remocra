...
public class TypeHydrantAnomalieNatureController {
    ...
    public ResponseEntity<java.lang.String> create(final @RequestBody String json) {
        try {
            ...
            return new AbstractExtObjectSerializer<TypeHydrantAnomalieNature>("TypeHydrantAnomalieNature created") {
                @Override
    ...
    public ResponseEntity<java.lang.String> update(final @PathVariable Long id, final @RequestBody String json) {
        try {
            ...
            if (attached != null) {
                return new AbstractExtObjectSerializer<TypeHydrantAnomalieNature>("TypeHydrantAnomalieNature updated.") {
                    @Override
                    protected TypeHydrantAnomalieNature getRecord() throws BusinessException {
                        return attached;
                    }

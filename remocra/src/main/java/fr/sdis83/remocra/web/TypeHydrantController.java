...
@RequestMapping("/typehydrants")
@Controller
public class TypeHydrantController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeHydrantController() {
        super(TypeHydrant.class);
    }

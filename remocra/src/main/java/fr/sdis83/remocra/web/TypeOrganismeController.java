...
@Controller
public class TypeOrganismeController
    extends AbstractServiceableController<TypeOrganismeService, TypeOrganisme> {

  @Autowired private TypeOrganismeService service;
  ...
  protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
    return serializer
        .include(
            "data.typeOrganismeParent.id",
            "data.typeOrganismeParent.code",
            "data.typeOrganismeParent.nom")
        .exclude("data.typeOrganismeParent.*");
  }
  ...
  @RequestMapping(
      value = "/nbOrganismesAvecParentEtProfilSpecifique/{id}",
      method = RequestMethod.GET,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('REFERENTIELS_C')")
  protected ResponseEntity<java.lang.String> nbOrganismesAvecParentEtProfilSpecifique(

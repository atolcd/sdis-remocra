...
public class IndisponibiliteTemporaireController {
  ...
  @Autowired private HydrantIndispoTemporaireRepository hydrantIndispoTemporaireRepository;

  protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
    serializer
        .include("data.nomStatut")
        .include("data.id")
        .include("data.dateRappelDebut")
        .include("data.dateRappelFin")
        .include("data.dateDebut")
        .include("data.dateFin")
        .include("data.motif")
        .include("data.commune")
        .include("data.totalHydrants")
        .include("data.statut")
        .include("data.countHydrant")
        .include("data.hydrants.id")
        .include("data.hydrants.numero")
        .include("data.geometrie")
        .include("data.hydrants.jsonGeometrie")
        .include("data.hydrants.natureDeci")
  ...
  public ResponseEntity<String> listJson(
    ...
    return new AbstractExtListSerializer<HydrantIndispoTemporaire>(
        "fr.sdis83.remocra.domain.remocra.HydrantIndispoTemporaire retrieved.") {
      @Override
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        serializer
            .include("data.nomStatut")
      ...
      protected List<HydrantIndispoTemporaire> getRecords() {
        return indisponibiliteTemporaireService.getIndisponibilites(
            limit, start, itemFilterList, sortList);
      }
  ...
  public ResponseEntity<String> listRecords(
    ...
    return new AbstractExtListSerializer<HydrantIndispoTemporaireRecord>(
        "fr.sdis83.remocra.domain.remocra.HydrantIndispoTemporaire retrieved.") {
      @Override
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        serializer
      ...
      protected List<HydrantIndispoTemporaireRecord> getRecords() {
        List<HydrantIndispoTemporaireRecord> l =
            hydrantIndispoTemporaireRepository.getAll(itemFilterList, limit, start, sortList);
        return l;
      }
  ...
  public ResponseEntity<java.lang.String> setIndispo(final @RequestBody String json) {
    try {
      final HydrantIndispoTemporaire attached =
          indisponibiliteTemporaireService.setIndispoTemp(json);
      return new SuccessErrorExtSerializer(true, "Nouvelle indisponibilité temporaire créée")
          .serialize();
  ...
  @RequestMapping(
      value = "/activeIndispoTemp/{id}",
      method = RequestMethod.POST,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('INDISPOS_U')")
  public ResponseEntity<java.lang.String> activeIndispoTemp(
      @PathVariable("id") Long id, final @RequestParam String dateDebut) {
    try {
      ...
      TypeHydrantIndispoStatut indispoStatut =
          TypeHydrantIndispoStatut.findTypeHydrantIndispoStatutByCode("EN_COURS").getSingleResult();
  ...
  @RequestMapping(
      value = "/leveIndispoTemp/{id}",
      method = RequestMethod.POST,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('INDISPOS_U')")
  public ResponseEntity<java.lang.String> leveIndispoTemp(
      @PathVariable("id") Long id, final @RequestParam String dateFin) {
    try {
      DateFormat df = new SimpleDateFormat(RemocraDateHourTransformer.FORMAT);
      HydrantIndispoTemporaire attached = HydrantIndispoTemporaire.findHydrantIndispoTemporaire(id);
  ...
  @RequestMapping(
      value = "/prolongerIndispo/{id}",
      method = RequestMethod.POST,
      headers = "Accept=application/json")
  @PreAuthorize("hasRight('INDISPOS_U')")
  public ResponseEntity<java.lang.String> prolongerIndispo(
      @PathVariable("id") Long id, final @RequestParam String dateFin) {
    try {
      DateFormat df = new SimpleDateFormat(RemocraDateHourTransformer.FORMAT);
      HydrantIndispoTemporaire attached = HydrantIndispoTemporaire.findHydrantIndispoTemporaire(id);
      ...
      attached.merge();
      attached.flush();
      return new SuccessErrorExtSerializer(true, "Indisponibilité temporaire prolongée")
          .serialize();
    } catch (Exception e) {
      return new SuccessErrorExtSerializer(false, e.getMessage()).serialize();
    }
  ...
  public ResponseEntity<java.lang.String> delete(@PathVariable("id") Long id) {
    try {
      ...
      return new SuccessErrorExtSerializer(true, "Indisponibilité temporaire supprimée")
          .serialize();
    } catch (Exception e) {
      return new SuccessErrorExtSerializer(false, e.getMessage()).serialize();
    }
  ...
  public ResponseEntity<java.lang.String> getIndispoTemp(final @PathVariable("id") Long id) {
    ...
    return new AbstractExtObjectSerializer<HydrantIndispoTemporaire>(
        "fr.sdis83.remocra.domain.remocra.HydrantIndispoTemporaire retrieved.") {
  ...
  @PreAuthorize("hasRight('INDISPOS_R')")
  public ResponseEntity<java.lang.String> verifHydrantTjrsIndispo(
    ...
    try {
      ...
      if (results.size() > 0) {
        ...
        sb.append("<ul>");
        sb.append(
            "Attention les PEI suivants demeurent indisponibles car ils présentent d\'autres anomalies : <br><br>");

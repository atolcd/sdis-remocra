...
@Controller
public class OldebVisiteSuiteController
    extends AbstractServiceableController<OldebVisiteSuiteService, OldebVisiteSuite> {

  @Autowired private OldebVisiteSuiteService service;

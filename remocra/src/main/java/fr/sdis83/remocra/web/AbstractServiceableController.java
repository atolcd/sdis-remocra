...
public abstract class AbstractServiceableController<
        ServiceT extends AbstractService<ModelT>, ModelT extends Object>
    extends AbstractRemocraController {
  ...
  protected ResponseEntity<java.lang.String> doListJson(
      Integer page,
      final Integer start,
      final Integer limit,
      String sorts,

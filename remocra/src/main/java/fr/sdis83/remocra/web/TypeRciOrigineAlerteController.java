...
@RequestMapping("/typercioriginealerte")
@Controller
public class TypeRciOrigineAlerteController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeRciOrigineAlerteController() {
        super(TypeRciOrigineAlerte.class);
    }

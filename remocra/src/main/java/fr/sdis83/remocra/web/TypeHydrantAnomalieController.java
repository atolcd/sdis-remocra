...
public class TypeHydrantAnomalieController {
  ...
  public ResponseEntity<java.lang.String> listJson(
    ...
    return new AbstractExtListSerializer<TypeHydrantAnomalie>(
        "fr.sdis83.remocra.domain.remocra.TypeHydrantAnomalie retrieved.") {

      @Override
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        return new JSONSerializer()
            .include("data.anomalieNatures", "data.anomalieNatures.saisies")
            .exclude("*.class")
        ...
        do {
          code =
              attached
                      ...
                      .toUpperCase()
                      .substring(0, attached.getNom().length() > 5 ? 4 : attached.getNom().length())
  ...
  public ResponseEntity<java.lang.String> update(
    ...
    return new SuccessErrorExtSerializer(
            false, "TypeHydrantAnomalie inexistant", HttpStatus.NOT_FOUND)
        .serialize();
  }

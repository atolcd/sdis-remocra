...
public abstract class AbstractExtListSerializer<T> {
  ...
  public ResponseEntity<String> serialize() {
    ...
    return new ResponseEntity<String>(
        getJsonSerializer().serialize(response), responseHeaders, returnStatus);
  }
  ...
  /**
   * Par defaut Null quand le count est egal au nombre de resultats de GetRecords (cas où il n'y a
   * pas de paging).
   *
   * @return

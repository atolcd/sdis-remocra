...
public class AdressesController extends AbstractRemocraController {
    ...
    public ResponseEntity<String> alertes() {
        ...
        fc.getSerializer().include("features.properties.documents").transform(AlerteDocumentTransformer.getInstance(), AlerteDocument.class);
    ...
    public ResponseEntity<String> alerte(MultipartHttpServletRequest request, final @RequestParam String jsonAlerte, final @RequestParam int fileCounter) {
        try {
            ...
            // Réponse
            return new AbstractExtObjectSerializer<Feature>("L'alerte a bien été créée.", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {

                @Override
                protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {

                    return super.additionnalIncludeExclude(serializer).transform(new AbstractTransformer() {
                    ...
                    }, "data.geometry").include("data.properties.documents").transform(AlerteDocumentTransformer.getInstance(), AlerteDocument.class);
                }

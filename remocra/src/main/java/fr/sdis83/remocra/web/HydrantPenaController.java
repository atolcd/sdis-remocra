...
public class HydrantPenaController {
  ...
  @Autowired private HydrantPenaService hydrantPenaService;
  ...
  public ResponseEntity<java.lang.String> getHydrant(final @PathVariable("id") Long id) {
    ...
    return new AbstractExtObjectSerializer<HydrantPena>(
        "fr.sdis83.remocra.domain.remocra.Hydrant-Pena retrieved.") {
  ...
  public ResponseEntity<java.lang.String> createHydrant(MultipartHttpServletRequest request) {
    ...
    try {
      ...
      return new AbstractExtObjectSerializer<HydrantPena>(
          "Hydrant-Pena created", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
        @Override
  ...
  public ResponseEntity<java.lang.String> updateHydrant(
    ...
    try {
      ...
      if (attached != null) {
        ...
        return new AbstractExtObjectSerializer<HydrantPena>(
            "Hydrant Pena updated.", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
          @Override
          protected HydrantPena getRecord() throws BusinessException {
            return attached;
          }
  ...
  /**
   * Droits nécessaires : HYDRANTS.READ ou RCI.CREATE car utilisé pour récupérer les coordonnées
   *
   * @param srid
   * @param wkt
   * @return
  ...
  public ResponseEntity<java.lang.String> findCoordDfci(
    ...
    try {
      ...
      logger.debug(
          "Aucune entrée trouvée dans la table remocra_referentiel.carro_dfci pour " + wkt);

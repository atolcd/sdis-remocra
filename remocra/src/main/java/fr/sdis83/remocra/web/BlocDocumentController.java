...
public class BlocDocumentController extends AbstractRemocraController {
  ...
  @Autowired private BlocDocumentService blocDocumentService;
  ...
  public ResponseEntity<java.lang.String> create(MultipartHttpServletRequest request) {
    ...
    try {
      ...
      return new AbstractExtObjectSerializer<BlocDocument>(
          "BlocDocument created", SuccessErrorExtSerializer.DEFAULT_CONTENT_TYPE) {
        @Override
  ...
  public ResponseEntity<java.lang.String> list(
    ...
    return new AbstractExtListSerializer<BlocDocument>("Model retrieved.") {
      ...
      protected JSONSerializer additionnalIncludeExclude(JSONSerializer serializer) {
        ...
        return serializer
            // Profils de droits
            .include("data.profilDroits.id")
            .include("data.profilDroits.nom")
            .exclude("data.profilDroits.*")
            // Thématiques
            .include("data.thematiques.id")
            .include("data.thematiques.nom")
            .exclude("data.thematiques.*")
            // Autres
  ...
  public ResponseEntity<java.lang.String> update(
      MultipartHttpServletRequest request, @PathVariable("id") Long id) {
    String json = request.getParameter("data");
    Map<String, MultipartFile> files = request.getFileMap();
    try {

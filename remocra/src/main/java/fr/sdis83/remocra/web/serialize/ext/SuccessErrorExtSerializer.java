...
public final class SuccessErrorExtSerializer {
  ...
  public SuccessErrorExtSerializer(
      boolean success, String successErrorMessage, String contentType) {
    this(success, successErrorMessage);
    this.contentType = contentType;
  }

  public SuccessErrorExtSerializer(
      boolean success, String successErrorMessage, HttpStatus errorStatus) {
  ...
  public SuccessErrorExtSerializer(
      boolean success, String successErrorMessage, HttpStatus errorStatus, String contentType) {
  ...
  public ResponseEntity<String> serialize() {
    ...
    // passe pas)...
    responseHeaders.add(
        "Content-Type", this.contentType == null ? DEFAULT_CONTENT_TYPE : this.contentType);

...
@RequestMapping("/typeoldebresidence")
@Controller
public class TypeOldebResidenceController<T extends ITypeReferenceNomActif> extends AbstractTypeReferenceController<T> {

    public TypeOldebResidenceController() {

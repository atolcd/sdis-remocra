...
@XmlSeeAlso({
  HydrantCiterneEnterre.class,
  HydrantCoursEau.class,
  HydrantPlanEau.class,
  HydrantPuisard.class,
  HydrantRetenue.class,
  HydrantReserveIncendie.class,
  HydrantPointAspiration.class,
  HydrantAspirationIndetermine.class,
  HydrantPuitPuisard.class,
  HydrantCiterneAerienne.class,
  HydrantCiterneEn.class,
  HydrantChateauEau.class,
  HydrantPoteauRelais.class
})

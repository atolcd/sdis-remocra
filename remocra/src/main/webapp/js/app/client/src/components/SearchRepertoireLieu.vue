<template>
  <form v-on:submit.prevent>
    <autocomplete :input-attrs="{ placeholder: 'Repertoire des lieux' }" v-model="selected" :items="results" :get-label="getLabel" :component-item='repertoireLieuTemplate' :auto-select-one-item="true" @update-items="search" @item-selected="repertoireSelected"

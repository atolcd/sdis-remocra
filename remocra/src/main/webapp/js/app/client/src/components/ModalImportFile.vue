  ...
  <div id="modalFile">
    <b-modal ref="modalImportFile" title="Importer un fichier" ok-title="Valider" cancel-title="Annuler" @ok="handleOk" @hidden="clearFields">
      <form @submit.stop.prevent="handleSubmit">
        ...
        <b-form-checkbox id="originalStyle" class="checkboxStyle" v-model="originalStyle" v-show="isKml">
          Conserver les styles du fichier
        </b-form-checkbox>
...
export default {
  ...
  methods: {
    ...
    creationCoucheKml: function(evt){
      ...
      var kmlFormat = new KML({extractStyles: this.originalStyle});
      var kmlFeatures;
      // on ajoute les features à la variable

...
Ext.define('Sdis.Remocra.features.admin.typereference.ProfilUtilisateurGrid', {
    extend: 'Sdis.Remocra.features.admin.typereference.TypeReferenceGrid',
    alias: 'widget.crAdminProfilUtilisateurGrid',
            ...
            columns: [
                ...
                typeRefGridCols.nom,
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        ...
                        return to && to.get('nom')?to.get('nom'):null;
                    },
                    editor: {

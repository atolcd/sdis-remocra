...
Ext.require('Sdis.Remocra.features.gestionnaires.ManageSites');
...
Ext.define('Sdis.Remocra.controller.Router', {
    ...
    initRoutes: function() {
        ...
        this.routes['manageSites'] = this.getManageSitesRoutes();
    ...
    getManageGestionnairesRoutes: function() {
        var routes = [];
        routes['index'] = {
    ...
    getOrganismesAPIRoutes: function() {
        var routes = [];
        routes['index'] = {
            xtype: 'crOrganismesAPI'
        };
        return routes;
    },

    getTransfertsAutomatisesRoutes: function(){
        var routes = [];
        routes['index'] = {
            xtype: 'crTransfertsAutomatises'
        };
        return routes;
    }
});

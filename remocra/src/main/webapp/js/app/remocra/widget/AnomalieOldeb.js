...
Ext.define('Sdis.Remocra.widget.AnomalieOldeb', {
    extend: 'Ext.form.FieldSet',
    alias: 'widget.anomalieOldeb',
    title: 'Anomalie',
    ...
    initComponent: function() {
        ...
        me.on('destroy', function() {
            ...
            Ext.getStore('TypeOldebAnomalie').rejectChanges();
    ...
    setSelected: function(records) {
        ...
        Ext.Array.each(records, function(item) {
            var record = this.getStore().getById(item.id);
            if (record != null) {
                Ext.Array.include(this.selectedRecord, record);
            } else {

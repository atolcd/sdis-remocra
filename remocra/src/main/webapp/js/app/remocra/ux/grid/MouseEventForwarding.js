// --
// -- Modification CVA. Pour gestion des dépendances
// --
Ext.ns('Ext.ux.grid');
Ext.define('Ext.ux.grid.MouseEventForwarding', {});
 ...
 */
// -- 
// -- Modification CVA. Validé sur ExtJS 4.07
// --
        ...
        forwardMouseEvents: function(evt) {
            ...
            for (var i = 0, l = evts.length; i < l; i++) {
                this.on(evts[i], function(e) {
                	// -- 
                	// -- Modification CVA. getScroll à part pour IE (à valider sur Safari car pas testé...)
                	// --
//                	var s = (Ext.isGecko) ? getScroll() : [0, 0],
                	var s = (Ext.isIE!==true) ? getScroll() : [0, 0],
                        be = e.browserEvent,

    ...
    initComponent: function() {
        ...
        var formPanel = new Ext.form.FormPanel({
            ...
            listeners: {
                render: function() {
                    ...
                    Ext.Function.defer(function(){this.getComponent('form').getComponent(fieldFocusId).focus();}, 100, this);
                }, scope: this
            },
            keys: [{
        ...
        if (this.inAWindow!==false) {
            actionButtons.push(new Ext.Button({
                ...
                minWidth  : 70,
                listeners: {
                    click: function(){ this.fireEvent('cancel', this); },
                    scope: this
                }
            }));
        }
        actionButtons.push({
            xtype: 'box',
            autoEl: { tag: 'a', style: 'margin-left:20px;', href:'', onclick: 'Ext.getCmp(\''+this.id+'\').passwordForgotten();return false;', html: 'Choix du mot de passe' }
        });

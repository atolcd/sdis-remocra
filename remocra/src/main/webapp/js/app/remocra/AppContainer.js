                ...
                '<div id="content" class="appliContent">',
                    ...
                    '<div id="pageBottom" class="appliBlock">',
                        ...
                        '<div class="partenaires">',
                            ...
                            '<a class="licence" rel="license" href="https://github.com/atolcd/sdis-remocra" target="_blank">',
                                '<img style="vertical-align:top;margin-top:5px;" src="{resUrl}/images/remocra/partenaires/agplv3.png" alt="AGPLv3"',
                                ' title="REMOcRA de SDIS83 est mis à disposition selon les termes de la licence GNU AFFERO GENERAL PUBLIC LICENSE V3.',

...
public class HydrantAnomalies extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -1340612093;
	...
	private HydrantAnomalies(String alias, Table<Record> aliased) {
		this(alias, aliased, null);
	}

	private HydrantAnomalies(String alias, Table<Record> aliased, Field<?>[] parameters) {

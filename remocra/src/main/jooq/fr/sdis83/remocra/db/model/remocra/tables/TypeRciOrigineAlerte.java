...
public class TypeRciOrigineAlerte extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -797877116;
	...
	public TypeRciOrigineAlerte() {
		this("type_rci_origine_alerte", null);
	}
	...
	private TypeRciOrigineAlerte(String alias, Table<Record> aliased) {
		this(alias, aliased, null);
	}

	private TypeRciOrigineAlerte(String alias, Table<Record> aliased, Field<?>[] parameters) {

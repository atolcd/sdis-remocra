...
public class Reseau extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -347069328;
	...
	/**
	 * The column <code>couverture_hydraulique.reseau.source</code>.
	 */
	public final TableField<Record, Integer> SOURCE = createField("source", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>couverture_hydraulique.reseau.destination</code>.
	 */
	public final TableField<Record, Integer> DESTINATION = createField("destination", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>couverture_hydraulique.reseau.pei_troncon</code>.
	 */
	public final TableField<Record, Integer> PEI_TRONCON = createField("pei_troncon", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>couverture_hydraulique.reseau.traversable</code>.
	 */
	public final TableField<Record, Boolean> TRAVERSABLE = createField("traversable", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>couverture_hydraulique.reseau.sens_unique</code>.
	 */
	public final TableField<Record, Boolean> SENS_UNIQUE = createField("sens_unique", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaulted(true), this, "");
	...
	/**
	 * The column <code>couverture_hydraulique.reseau.niveau</code>.
	 */
	public final TableField<Record, Integer> NIVEAU = createField("niveau", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");

...
public class DepotDocument extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -2031745189;
	...
	private DepotDocument(String alias, Table<Record> aliased) {
		this(alias, aliased, null);
	}

	private DepotDocument(String alias, Table<Record> aliased, Field<?>[] parameters) {

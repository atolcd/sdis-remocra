...
public class ProcessusEtlModele extends TableImpl<Record> {
	...
	private static final long serialVersionUID = 1832542812;
	 ...
	 */
	public final TableField<Record, Long> PRIORITE = createField("priorite", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaulted(true), this, "Niveau de priorité d'exécution par défaut. De 1 : Pas prioritaire urgent à 5 : Très urgent");
	...
	public ProcessusEtlModele() {
		this("processus_etl_modele", null);
	}
	...
	private ProcessusEtlModele(String alias, Table<Record> aliased) {
		this(alias, aliased, null);
	}

	private ProcessusEtlModele(String alias, Table<Record> aliased, Field<?>[] parameters) {
		super(alias, Remocra.REMOCRA, aliased, parameters, "Modèle de processus ETL PDI mobilisable sous forme de tâche planifiée ou à la demande d'un utilisateur via l'interface REMOCRA");
	}

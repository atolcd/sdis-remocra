...
begin
    ...
    numero_patch := 158;
    description_patch := 'Couverture hydraulique : spécification de l''étape de zonage';
...
('PLANIFICATION_DECI_ISODISTANCES', 'Isodistances de la couverture hydraulique', '100, 150, 300, 350', 1, 'Planification DECI');
...
ALTER FUNCTION couverture_hydraulique.parcours_couverture_hydraulique(integer, integer, integer, int[])
    OWNER TO remocra;
...
ALTER FUNCTION couverture_hydraulique.couverture_hydraulique_zonage(integer, integer[])
    OWNER TO remocra;

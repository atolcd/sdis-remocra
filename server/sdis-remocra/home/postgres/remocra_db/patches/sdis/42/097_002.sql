...
CREATE OR REPLACE FUNCTION remocra.calcul_debit_pression_42(id_hydrant bigint)
  RETURNS void AS
$BODY$
DECLARE
...
COST 100;
ALTER FUNCTION remocra.calcul_debit_pression_42(bigint) OWNER TO postgres;
GRANT EXECUTE ON FUNCTION remocra.calcul_debit_pression_42(bigint) TO public;
GRANT EXECUTE ON FUNCTION remocra.calcul_debit_pression_42(bigint) TO postgres;
GRANT EXECUTE ON FUNCTION remocra.calcul_debit_pression_42(bigint) TO remocra;

CREATE OR REPLACE FUNCTION remocra.trg_calcul_debit_pression_42() RETURNS trigger AS
$BODY$
DECLARE
	p_rec record;
BEGIN
	...
	perform remocra.calcul_debit_pression_42(p_rec.id);
...
LANGUAGE plpgsql VOLATILE
COST 100;
ALTER FUNCTION remocra.trg_calcul_debit_pression_42() OWNER TO postgres;
CREATE TRIGGER trig_debit_pression_42 AFTER INSERT OR UPDATE ON remocra.hydrant_pibi FOR EACH ROW EXECUTE PROCEDURE remocra.trg_calcul_debit_pression_42();

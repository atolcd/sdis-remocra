...
begin
    ...
    numero_patch := 101;
    description_patch := 'Suivi maj champ capacite hydrant_pena dans table tracabilite.hydrant';
...
ALTER TABLE tracabilite.hydrant ADD COLUMN capacite character varying;
...
BEGIN
    ...
    SET hbe = pena.hbe, materiau = mat.nom, vol_constate = v.nom, positionnement = p.nom, capacite = pena.capacite

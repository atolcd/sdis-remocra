...
sh kitchen.sh -file:"/var/remocra/pdi/traitements_sdis/77/pei_indisponibles/creer_traitement_pei_indisponibles.kjb" -level:Error -param:"PDI_FICHIER_PARAMETRE=/home/postgres/remocra_pdi/remocra.properties"
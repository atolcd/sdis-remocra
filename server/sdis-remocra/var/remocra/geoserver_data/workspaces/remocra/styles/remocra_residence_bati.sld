<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>remocra_residence_bati</sld:Name>
    <sld:UserStyle>
      <sld:Name>remocra_residence_bati</sld:Name>
      <sld:Title>Résidence</sld:Title>
      <sld:FeatureTypeStyle>
        <sld:Name>name</sld:Name>
        <sld:Rule>
          <sld:MinScaleDenominator>0</sld:MinScaleDenominator>
          <sld:MaxScaleDenominator>20000</sld:MaxScaleDenominator>
          <sld:Name>residence_bati</sld:Name>
          <sld:Title>Résidence</sld:Title>
          <sld:PolygonSymbolizer>
            ...
            <sld:Stroke>
              <sld:CssParameter name="stroke">#FFCC99</sld:CssParameter>
            </sld:Stroke>
          </sld:PolygonSymbolizer>
        </sld:Rule>
      </sld:FeatureTypeStyle>
          <!-- Etiquettes des bâtiments residences-->
       <sld:FeatureTypeStyle>
        <sld:Rule>
         <sld:MinScaleDenominator>0</sld:MinScaleDenominator>

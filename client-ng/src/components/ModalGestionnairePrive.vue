<template>
  <div>
    <b-modal
        id="modalGestionnairePrive"
        title="Gestionnaire de PEI privé"
        cancel-title="Annuler"
        ok-title="Valider"
        ref="modalGestionnairePrive"
        @ok="handleOk">
      <form ref="formGestionnairePrive" id="formGestionnairePrive">
        ...
        <b-form-group
          ...
          <b-form-input
              id="inputNom"
              v-model="nomGestionnaire" required>
          </b-form-input>
        </b-form-group>
        <b-form-group
            label="Code"
          ...
          <b-form-input
              id="inputCode"
              v-model="codeGestionnaire" required>
          </b-form-input>
        </b-form-group>
      </div>
      <b-form-group
...
export default {
  ...
  data() {
    return {
      ...
      showContact: false,
      contacts: [],
      fields:[ { key: 'civilite', label: 'Civilité' },
          { key: 'nom', label: 'Nom' },
          { key: 'prenom', label: 'Prenom' },
          { key: 'fonction', label: 'Fonction' },{ key: 'telephone', label: 'Téléphone' },
  ...
  methods: {
    ...
    addContact() {
          ...
          _.remove(this.contacts, o => o.id == this.idContact)
         this.contacts.push({ id: this.idContact!=null ? this.idContact : null, appartenance:'GESTIONNAIRE',
         id_appartenance:'1',

	...
	<div>
		...
		<div class="row">
			<div class="col-md-3 vertical-bottom">
				<b-form-checkbox
					id="illimitee"
					v-model="hydrant.illimitee"
					class="parametre"
					size="sm"
					v-on:change="onIllimiteeChecked">
					Capacité illimitée
				</b-form-checkbox>
			</div>
			...
			<div class="col-md-3 vertical-bottom">
				<b-form-checkbox
					id="incertaine"
					v-model="hydrant.incertaine"
					class="parametre"
					size="sm"
					:disabled="hydrant.illimitee">
	...
	methods: {
		...
		onIllimiteeChecked(value) {
			if(value){
				...
				this.hydrant.incertaine = this.hydrantRecord.incertaine;

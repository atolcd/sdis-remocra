<template>
  <div id="FicheIndisponibiliteTemporaire">
    <b-modal id="modalFicheIndispo"  ref="modalFicheIndispo" no-close-on-backdrop :title="this.title"
  ...
  methods: {
    ...
    handleOk(evt){
      ...
      if(this.checkFormValidity()) {
        ...
        if(this.value.heureIndispo != null)
          this.value.heureIndispo = this.value.heureIndispo.substr(0,5);
      }
    },
    ...
    handleSubmit(){
      var nouvelleIndispo = {"idIndispoTemp": this.idIndispoTemp,

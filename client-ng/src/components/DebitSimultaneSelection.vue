<template>
<b-modal id="modalDebitSimultaneSelection" ref="modalDebitSimultaneSelection" no-close-on-backdrop :title="modalTitle" ok-title="OK" cancel-title="Annuler" size="sm" @hidden="close()" header-bg-variant="primary" header-text-variant="light"
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <form ref="form" @submit.stop.prevent="handleOk">
        <b-form-select id="type" v-model="selected" :options="comboDebits" size="sm" :state="formValide" required></b-form-select>
      </form>
    </div>
  </div>
</b-modal>

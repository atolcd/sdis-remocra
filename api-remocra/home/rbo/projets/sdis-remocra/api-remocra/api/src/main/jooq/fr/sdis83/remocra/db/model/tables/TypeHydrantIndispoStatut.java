...
public class TypeHydrantIndispoStatut extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1016659284;
     ...
     */
    public final TableField<Record, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('remocra.type_hydrant_indispo_statut_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    ...
    public TypeHydrantIndispoStatut() {
        this(DSL.name("type_hydrant_indispo_statut"), null);
    }
    ...
    public TypeHydrantIndispoStatut(String alias) {
        this(DSL.name(alias), TYPE_HYDRANT_INDISPO_STATUT);
    }

    /**
     * Create an aliased <code>remocra.type_hydrant_indispo_statut</code> table reference
     */
    public TypeHydrantIndispoStatut(Name alias) {
        this(alias, TYPE_HYDRANT_INDISPO_STATUT);
    }

    private TypeHydrantIndispoStatut(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TypeHydrantIndispoStatut(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Statut de l'indisponibilité"));
    }

    public <O extends Record> TypeHydrantIndispoStatut(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, TYPE_HYDRANT_INDISPO_STATUT);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TYPE_HYDRANT_INDISPO_STATUT_PKEY);
    }
    ...
    public TypeHydrantIndispoStatut as(String alias) {
        return new TypeHydrantIndispoStatut(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TypeHydrantIndispoStatut as(Name alias) {
    ...
    public TypeHydrantIndispoStatut rename(String name) {
        return new TypeHydrantIndispoStatut(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TypeHydrantIndispoStatut rename(Name name) {

...
public class HydrantPibi extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 517347542;
    ...
    public fr.sdis83.remocra.db.model.tables.HydrantPibi hydrantPibi() {
        return new fr.sdis83.remocra.db.model.tables.HydrantPibi(this, Keys.HYDRANT_PIBI__FK_JUMELE);
    }

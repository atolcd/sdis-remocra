...
public class Role extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -1386011953;
     ...
     */
    public final TableField<Record, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('remocra.role_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    ...
    private Role(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> Role(Table<O> child, ForeignKey<O, Record> key) {
    ...
    public Thematique thematique() {
        return new Thematique(this, Keys.ROLE__ROLE_THEMATIQUE);
    }

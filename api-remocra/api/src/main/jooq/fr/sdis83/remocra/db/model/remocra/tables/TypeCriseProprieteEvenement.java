...
public class TypeCriseProprieteEvenement extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -1134737454;
     ...
     */
    public final TableField<Record, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('remocra.type_crise_propriete_evenement_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "Identifiant interne");
    ...
    public TypeCriseProprieteEvenement() {
        this(DSL.name("type_crise_propriete_evenement"), null);
    }
    ...
    public TypeCriseProprieteEvenement(String alias) {
        this(DSL.name(alias), TYPE_CRISE_PROPRIETE_EVENEMENT);
    }

    /**
     * Create an aliased <code>remocra.type_crise_propriete_evenement</code> table reference
     */
    public TypeCriseProprieteEvenement(Name alias) {
        this(alias, TYPE_CRISE_PROPRIETE_EVENEMENT);
    }

    private TypeCriseProprieteEvenement(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TypeCriseProprieteEvenement(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Propriété complémentaire pouvant être renseignée lors de la création ou de la modification d'un évènement"));
    }

    public <O extends Record> TypeCriseProprieteEvenement(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, TYPE_CRISE_PROPRIETE_EVENEMENT);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TYPE_CRISE_PROPRIETE_EVENEMENT_NATURE_EVENEMENT, Indexes.TYPE_CRISE_PROPRIETE_EVENEMENT_PKEY);
    }
    ...
    public TypeCriseNatureEvenement typeCriseNatureEvenement() {
        return new TypeCriseNatureEvenement(this, Keys.TYPE_CRISE_PROPRIETE_EVENEMENT__TYPE_CRISE_PROPRIETE_EVENEMENT_NATURE_EVENEMENT_FK);
    }
    ...
    public TypeCriseProprieteEvenement as(String alias) {
        return new TypeCriseProprieteEvenement(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TypeCriseProprieteEvenement as(Name alias) {
    ...
    public TypeCriseProprieteEvenement rename(String name) {
        return new TypeCriseProprieteEvenement(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TypeCriseProprieteEvenement rename(Name name) {

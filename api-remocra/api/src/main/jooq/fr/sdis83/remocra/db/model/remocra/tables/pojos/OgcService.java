...
public class OgcService implements Serializable {
    ...
    private static final long serialVersionUID = 1977934430;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OgcService (");

        sb.append(id);
        sb.append(", ").append(typeService);
        sb.append(", ").append(nom);
        sb.append(", ").append(description);
        sb.append(", ").append(ogcSource);

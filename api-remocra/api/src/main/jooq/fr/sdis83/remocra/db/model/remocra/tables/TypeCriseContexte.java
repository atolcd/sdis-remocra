...
public class TypeCriseContexte extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -202163157;
     ...
     */
    public final TableField<Record, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('remocra.type_crise_contexte_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "Identifiant interne");
    ...
    public TypeCriseContexte() {
        this(DSL.name("type_crise_contexte"), null);
    }
    ...
    public TypeCriseContexte(String alias) {
        this(DSL.name(alias), TYPE_CRISE_CONTEXTE);
    }

    /**
     * Create an aliased <code>remocra.type_crise_contexte</code> table reference
     */
    public TypeCriseContexte(Name alias) {
        this(alias, TYPE_CRISE_CONTEXTE);
    }

    private TypeCriseContexte(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TypeCriseContexte(Name alias, Table<Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Gestion de crise : Type de contexte dans lequel est gérée la crise. Deux contextes cohabitent simultanément pour chaque épisode : \"Opérationnel\" et \"Anticipation\". Les données cartographiques associées peuvent varier en fonction du contexte de même que les types d'évenements à renseigner"));
    }

    public <O extends Record> TypeCriseContexte(Table<O> child, ForeignKey<O, Record> key) {
        super(child, key, TYPE_CRISE_CONTEXTE);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TYPE_CRISE_CONTEXTE_CODE_KEY, Indexes.TYPE_CRISE_CONTEXTE_NOM_KEY, Indexes.TYPE_CRISE_CONTEXTE_PKEY);
    }
    ...
    public TypeCriseContexte as(String alias) {
        return new TypeCriseContexte(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public TypeCriseContexte as(Name alias) {
    ...
    public TypeCriseContexte rename(String name) {
        return new TypeCriseContexte(DSL.name(name), null);
    }
     ...
     */
    @Override
    public TypeCriseContexte rename(Name name) {

  ...
  public String getAll(
    ...
    List<TypeHydrantAnomalieModel> list =
        context
            ...
            .on(TYPE_HYDRANT_NATURE.ID.eq(TYPE_HYDRANT_ANOMALIE_NATURE.NATURE))
            ...
            .where(
                condition
                    .and(TYPE_HYDRANT_NATURE.CODE.eq(codeNature.toUpperCase()))
                    .and(TYPE_HYDRANT.CODE.eq(typeHydrant.toUpperCase())))

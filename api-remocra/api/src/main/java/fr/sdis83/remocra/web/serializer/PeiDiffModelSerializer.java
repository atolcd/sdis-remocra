...
public class PeiDiffModelSerializer extends StdSerializer<PeiDiffModel> {
  ...
  public void serialize(
      PeiDiffModel pei, JsonGenerator jsonGenerator, SerializerProvider serializer)
      throws IOException {
    ...
    jsonGenerator.writeStringField(
        "dateModification", dateFormat.format(pei.getDateModification()));
    ...
    jsonGenerator.writeStringField(
        "utilisateurModificationOrganisme", pei.getUtilisateurModificationOrganisme());

...
public class MobileAuthFilter implements ContainerRequestFilter {
  ...
  @Inject javax.inject.Provider<UtilisateursRepository> utilisateursRepositoryProvider;
  ...
  public void filter(ContainerRequestContext requestContext) {
    ...
    if (!method.isAnnotationPresent(AuthDevice.class)
    ...
    final UserInfo userInfo =
        ImmutableUserInfo.of(
            utilisateursRepositoryProvider.get().getByUsername(username).id(),
            username,

...
@Inject
HttpServerWebapp(GuiceInjectorFactory guiceInjectorFactory, GuiceFilter guiceFilter,
                 HttpServerWebappModule.Settings settings, Application application, PersistFilter persistFilter) {
...
public void start() throws Exception {
        ...
        for (Map.Entry<String, String> entry : settings.defaultServletConfig().entrySet()) {
                context.setInitParameter("org.eclipse.jetty.servlet.Default." + entry.getKey(), entry.getValue());
        }

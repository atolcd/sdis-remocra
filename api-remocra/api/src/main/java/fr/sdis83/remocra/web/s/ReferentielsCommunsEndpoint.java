...
public class ReferentielsCommunsEndpoint {
  ...
  @Inject TypeOrganismesRepository typeOrganismesRepository;

  @Inject CommunesRepository communeRepository;

  @Inject VoiesRepository voiesRepository;
  ...
  @Operation(
      summary = "Retourne les types d'organismes susceptibles d'exploiter REMOCRA",
      tags = {"Référentiels communs"})
  ...
  @Path("/communes")
  @Operation(
      summary = "Retourne la liste des communes",
      tags = {"Référentiels communs"})
  @RolesAllowed({UserRoles.RoleTypes.RECEVOIR})
  public Response getRefentielCommunes(
      final @Parameter(description = "Code INSEE de la commune") @QueryParam("code") String insee,
      final @Parameter(description = "Tout ou partie du nom de la commune") @QueryParam("commune")
          String commune,
      final @Parameter(description = "Nombre maximum de résultats à retourner") @QueryParam("limit")
          Integer limit,
      final @Parameter(description = "Retourne les informations à partir de la n-ième ligne")
  ...
  @Path("/voies/{insee}")
  @Operation(
      summary = "Retourne les voies d'une commune donnée",
      tags = {"Référentiels communs"})
  @RolesAllowed({UserRoles.RoleTypes.RECEVOIR})
  public Response getRefentielVoies(
      final @Parameter(description = "Code INSEE de la commune", required = true) @PathParam(
              "insee") String insee,
      final @Parameter(description = "Tout ou partie du nom de la voie") @QueryParam("nom") String
              nom,
      final @Parameter(description = "Nombre maximum de résultats à retourner") @QueryParam("limit")
          Integer limit,
      final @Parameter(description = "Retourne les informations à partir de la n-ième ligne")
  ...
  public Response getRefentielOrganismes(
      final @Parameter(description = "Code de la nature de l'organisme") @QueryParam("codeNature")
          String codeNature,
      final @Parameter(description = "Nombre maximum de résultats à retourner") @QueryParam("limit")
          Integer limit,
      final @Parameter(description = "Retourne les informations à partir de la n-ième ligne")

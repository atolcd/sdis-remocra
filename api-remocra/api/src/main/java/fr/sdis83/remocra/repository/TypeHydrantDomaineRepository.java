...
public class TypeHydrantDomaineRepository {

  private final DSLContext context;

  @Inject
  public TypeHydrantDomaineRepository(DSLContext context) {
  ...
  public String getAll(Integer start, Integer limit) throws JsonProcessingException {
      ...
      List<ReferentielModel> list = context
        .selectFrom(TYPE_HYDRANT_DOMAINE)
  ...
  private Integer count() {
    return context.fetchCount(TYPE_HYDRANT_DOMAINE);
  }
}
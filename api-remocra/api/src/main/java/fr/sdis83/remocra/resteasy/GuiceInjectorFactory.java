...
public class GuiceInjectorFactory implements InjectorFactory {
  ...
  public ConstructorInjector createConstructor(
      Constructor constructor, ResteasyProviderFactory factory) {
    return new GuiceConstructorInjector(
        constructor, delegate.createConstructor(constructor, factory));
  }

  @Override
  public PropertyInjector createPropertyInjector(
      Class resourceClass, ResteasyProviderFactory factory) {
    return delegate.createPropertyInjector(resourceClass, factory);
  }

  @Override
  public ValueInjector createParameterExtractor(
    ...
    return delegate.createParameterExtractor(
        injectTargetClass, injectTarget, type, genericType, annotations, factory);
  }
  ...
  public ValueInjector createParameterExtractor(
      ...
      ResteasyProviderFactory factory) {
    return delegate.createParameterExtractor(
        injectTargetClass, injectTarget, type, genericType, annotations, useDefault, factory);
  }

  @Override
  public ValueInjector createParameterExtractor(
      Parameter parameter, ResteasyProviderFactory providerFactory) {
    return delegate.createParameterExtractor(parameter, providerFactory);
  }

  @Override
  public MethodInjector createMethodInjector(
  ...
  public ConstructorInjector createConstructor(
    ...
    return new GuiceConstructorInjector(
        constructor.getConstructor(), delegate.createConstructor(constructor, providerFactory));
  }

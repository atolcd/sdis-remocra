...
public class NumeroUtilRepository {
    ...
    static ParamConfRepository paramsConfRepository;

    private final String HYDRANT_NUMEROTATION_METHODE = "HYDRANT_NUMEROTATION_METHODE";


    @Inject
    public NumeroUtilRepository(DSLContext context, ParamConfRepository paramsConfRepository) {
    ...
    public static MethodeNumerotation getHydrantNumerotationMethode() {
        ...
        try {
            m = MethodeNumerotation.valueOf("M_" +
                    paramsConfRepository.getByCle("HYDRANT_NUMEROTATION_METHODE").getValeur());
        } catch (Exception e) {
    ...
    public static MethodeNumerotationInterne getHydrantNumerotationInterneMethode() {
        ...
        try {
            m = MethodeNumerotationInterne.valueOf("M_" +
                    paramsConfRepository.getByCle("HYDRANT_NUMEROTATION_METHODE").getValeur());
        } catch (Exception e) {
            System.err.println("HYDRANT_NUMEROTATION_METHODE non reconnu (-> 83). Valeurs autorisées (sans M_) : "
                    + ArrayUtils.toString(MethodeNumerotation.values()));
